...
const requestedPort = Number(process.argv[2] ?? 3230);
...
writeFileSync(join(projectRoot, "dev-server.pid"), `${child.pid}\n`, "utf8");
writeFileSync(join(projectRoot, "dev-server.port"), `${port}\n`, "utf8");
