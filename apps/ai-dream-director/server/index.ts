...
import {
  defaultModels,
  GenerateDreamRequestSchema,
  modelSuggestions,
  providerLabels,
  type ApiError
} from "../src/shared/contracts.js";
import { demoDirectorOutput, ProviderError } from "./dreamDirector.js";
import { getProviderCatalog, HubModelError } from "./hubModels.js";
import { generateWithModel } from "./modelGateway.js";
...
app.listen(port, "127.0.0.1", () => {
  console.log(`AI Dream Director running at http://127.0.0.1:${port}${basePath || ""}`);
});
