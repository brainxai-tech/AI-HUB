import { defaultModels, isGptModel, type RealProvider } from "../src/shared/contracts.js";
...
const PROJECT_ID = "ai-misunderstanding-simulator";
const PROJECT_PATH = "/misunderstanding";
...
function assertHubRoute(provider: RealProvider, model: string) {
  if (provider !== "openai") {
